package com.example.wph_seckill_consumer.util;

import com.alibaba.fastjson.JSON;
import com.example.wph_seckill_consumer.config.PersistableCronTriggerFactoryBean;
...
public class JobUtil {
     ...
     */
    public static JobDetail createJob( String message, Class<? extends QuartzJobBean> jobClass, boolean isDurable,
                                      ApplicationContext context, String jobName, String jobGroup,Date jobendtime){
        ...
        jobDataMap.put("subday",DateUtil.DchangeS(jobendtime));
